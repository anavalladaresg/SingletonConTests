    ...
    public void comprobarNumero() {
        for (int i = 0; i < nMax; i++) {
            ...
            if (this.numeroPropuesto == this.numeroAleatorio) {
                ...
                System.out.println("Lo siento, no has adivinado el número. Intenta de nuevo.");
            }
        }
        System.out.println("Has agotado tus intentos. El número era " + this.numeroAleatorio);
    }
